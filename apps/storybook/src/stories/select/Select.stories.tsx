...
import { Select, Flex } from '@yorkie-ui/core';
...
const meta = {
  ...
  argTypes: {
    size: {
      control: { type: 'radio' },
      options: ['sm', 'md', 'lg'],
      description: 'The width size of the select.',
      table: {
...
export const Overview: Story = {
  render: (args) => {
    ...
    return (
      <Flex height="8000">
        <Select.Root positioning={{ sameWidth: true }} width="xs" {...args} items={items}>
    ...
    return (
      <Select.Root positioning={{ sameWidth: true }} width="2xs" height="280px" items={items}>
        ...
        <Select.Control>
          <Select.Trigger>
            <Select.ValueText placeholder="Select a Framework" />
            <Select.Indicator>{/* <Icons.IconArrow /> */}</Select.Indicator>
          </Select.Trigger>
          <Select.ClearTrigger>{/* <Button>Clear</Button> */}</Select.ClearTrigger>
        </Select.Control>
        <Select.Positioner>
          <Select.Content>
            <Select.ItemGroup id="framework">
    ...
    return (
      <Select.Root items={items} multiple width="2xs">
        ...
        <Select.Control>
          ...
          <Select.ClearTrigger>{/* <Button variant="solid">Clear</Button> */}</Select.ClearTrigger>
        </Select.Control>
        <Select.Positioner>
          <Select.Content>
            <Select.ItemGroup id="framework">
