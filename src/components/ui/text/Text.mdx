  ...
  source={{
    ...
    code: `
      <div>
        ...
        <Text size="8xl">Yorike</Text>
        <Text size="9xl">Yorike</Text>
      </div>
    `,
  }}
/>
...
### [Responsive Text](#responsive-heading)

You can adjust the text according to screen.
  ...
  source={{
    ...
    code: `
      <div>
        ...
        <Text fontSize={{ base: 'sm', md: 'md', lg: '3xl' }} fontWeight={{ base: 'normal', md: 'medium', lg: 'semibold' }}>Responsive a Text</Text>
      </div>
    `,
  }}
/>