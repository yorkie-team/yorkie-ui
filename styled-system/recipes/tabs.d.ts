...
export interface TabsRecipe {
  ...
  (props?: TabsVariantProps): Pretty<Record<"root" | "list" | "trigger" | "content" | "indicator" | "root" | "list" | "trigger" | "content" | "indicator" | "root" | "list" | "trigger" | "content" | "indicator", string>>
