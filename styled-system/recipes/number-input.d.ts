...
export interface NumberInputRecipe {
  ...
  (props?: NumberInputVariantProps): Pretty<Record<"root" | "label" | "input" | "control" | "incrementTrigger" | "decrementTrigger" | "scrubber" | "root" | "label" | "input" | "control" | "incrementTrigger" | "decrementTrigger" | "scrubber", string>>
